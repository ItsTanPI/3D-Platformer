...
public class Movement : MonoBehaviour
{
    ...
    public enum InputSpace { CameraRelative, WorldRelative }
    [SerializeField] private InputSpace inputSpace = InputSpace.CameraRelative;

    public void SetInputSpace(InputSpace space)
    {
        inputSpace = space;
    }
    ...
    void Move()
    {
        if (moveInput.magnitude > 0f && !isAim)
        {
            ...
            {
                if (inputSpace == InputSpace.CameraRelative)
                {
